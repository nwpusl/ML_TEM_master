...
def show_importance(model, feature_names, label_name='预测值', save_path='.', pic_index=0):
...
def shap_analysis(model, x_test, label_name='预测值', element_name='FNS/Or', save_path='.'):
    shap.initjs()
